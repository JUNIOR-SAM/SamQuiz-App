...
//         if (storedName) {
//             userNameElement.innerHTML = `${greeting}, <span style="font-weight:bold;">${storedName}</span>!`;
//         } else {
//             userNameElement.textContent = `${greeting}, Guest!`;
//         }
//     }

//     // Always update greeting
//     updateGreeting();

//     // If your other script tries to overwrite, reset every 1s
...
//     } else {
//         userPhotoElement.src = 'default-profile.png';
//     }
// });
...
//         // Show profile pic & name if available
//         if (user.photoURL) {
//             document.getElementById("dashboardProfilePic").src = user.photoURL;
//         }
//         if (user.displayName) {
//             document.getElementById("dashboardUserName").textContent = user.displayName;
//         } else {
//             document.getElementById("dashboardUserName").textContent = user.email;
//         }

//     } else {
//         // No user → redirect back to signin
